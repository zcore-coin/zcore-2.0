...
The ZCore project operates an open contributor model where anyone is
...
The following applies to code changes to the ZCore project, and is not to be
confused with overall ZCore Network Protocol consensus changes.

Whether a pull request is merged into ZCore rests with the project merge
...
Patches that change ZCore consensus rules are considerably more involved than
...
Where a patch set proposes to change the ZCore consensus, it must have been
...
The project leader is the release manager for each ZCore release.
