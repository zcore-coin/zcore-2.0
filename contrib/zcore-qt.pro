...
RESOURCES += src/qt/zcore.qrc src/qt/zcore_locale.qrc

TRANSLATIONS += src/qt/locale/zcore_bg.ts \
                src/qt/locale/zcore_de.ts \
                src/qt/locale/zcore_en.ts \
                src/qt/locale/zcore_es.ts \
                src/qt/locale/zcore_fi.ts \
                src/qt/locale/zcore_fr.ts \
                src/qt/locale/zcore_it.ts \
                src/qt/locale/zcore_ja.ts \
                src/qt/locale/zcore_pl.ts \
                src/qt/locale/zcore_pt.ts \
                src/qt/locale/zcore_ru.ts \
                src/qt/locale/zcore_sk.ts \
                src/qt/locale/zcore_sv.ts \
                src/qt/locale/zcore_vi.ts \
                src/qt/locale/zcore_zh_CN.ts \
                src/qt/locale/zcore_zh_TW.ts
