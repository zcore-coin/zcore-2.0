...
#   c) node1 mines 32 blocks, so now node 0 has 60001zcr, node 1 has 4250zcr, node2 has none.
#   d) node0 sends 601 zcr to node2, in two transactions (301 zcr, then 300 zcr).
