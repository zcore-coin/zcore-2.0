...
#ifndef ZCore_ZZCRWALLET_H
#define ZCore_ZZCRWALLET_H
...
public:
    CzZCRWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZZCR(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZZCR(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //ZCore_ZZCRWALLET_H
