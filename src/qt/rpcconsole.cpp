                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzZCRPathCustom = GetArg("-zzcrbackuppath", "");
    ...
    if(!strzZCRPathCustom.empty()) {
        ui->wallet_customzzcrbackuppath->setText(QString::fromStdString(strzZCRPathCustom));
        ui->wallet_customzzcrbackuppath_label->setVisible(true);
        ui->wallet_customzzcrbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzZCRPathCustom.empty()) && nCustomBackupThreshold > 0) {
