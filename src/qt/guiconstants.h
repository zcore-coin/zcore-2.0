...
/* ZCore GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "ZCore"
#define QAPP_ORG_DOMAIN "zcore.foundation"
#define QAPP_APP_NAME_DEFAULT "ZCore"
#define QAPP_APP_NAME_TESTNET "ZCore-Qt-testnet"
