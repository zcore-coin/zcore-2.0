...
/** Utility functions used by the ZCore Qt UI.
 */
namespace GUIUtil
{
...
// Render ZCore addresses in monospace font
...
// Parse "zcore:" URI into recipient object, return true on successful parsing
