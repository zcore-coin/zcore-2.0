...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ZCore address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zcore: URIs)"));
    ...
    privacyAction = new QAction(QIcon(":/icons/privacy"), tr("&ZCore Central"), this);
    privacyAction->setStatusTip(tr("Access the site and get all the information about ZCore"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ZCore"), this);
    aboutAction->setStatusTip(tr("Show information about ZCore"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ZCore"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ZCore addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ZCore addresses"));
    ...
    openAction->setStatusTip(tr("Open a ZCore: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Gentaium Core help message to get a list with possible ZCore command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ZCore client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ZCore network", "", count));
}
...
{
    QString strTitle = tr("ZCore"); // default title
