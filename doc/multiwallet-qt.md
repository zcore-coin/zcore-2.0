...
In order to support loading of multiple wallets in zcore-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is zcore.cpp.
...
Changes to zcore.cpp
----------------------
zcore.cpp is the entry point into zcore-qt, and as such, will require some minor modifications to provide hooks for
